...
# 각각에 대한 인코더 부분에서의 구해진 기울기의 각도를 구한후 디코더에서 생성되는 각도가 인코더의 각도와 일치하도록 만들자!!!
# 주간 보고서 작성하고 이 코드 이어서 작성하자!!
...
def A2B_att_based_generator(input_shape=(256, 256, 3),
    ...
    dim = 64        # concat을 중간에 또 추가해볼까? --> 메모리가 부족하진 않을까?--> 괜찮을지도??
